...
INDEX.HTML
  ...
  - Subtítulo explicando o objetivo sustentável da calculadora em linguagem que gere engajamento.
...
ROUTRES-DATA.JS - JS / DADOS DE ROTAS:
  ...
  - `findDistance: function(origin, destination)`
    - Encontra a distância entre duas cidades (em km) procurando o par nas rotas.
